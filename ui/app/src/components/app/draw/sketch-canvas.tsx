  ...
  */
  ...
  return (
    <div className={cn("relative h-full w-full touch-none select-none overflow-hidden", canDraw && "cursor-crosshair", className)} ref={box}>
      ...
      */}
      {w > 0 ? (
        <div className="absolute flex max-sm:bottom-30 max-sm:left-2 max-sm:w-13 max-sm:flex-col max-sm:items-center max-sm:gap-1.5 sm:right-2 sm:bottom-7 sm:items-center sm:gap-0.5 sm:rounded-xl sm:border sm:bg-card/85 sm:p-0.5 sm:backdrop-blur-sm sm:[&_svg]:size-3.5">
          {/* Panning is a drag on a phone, so the two arrows are a desk thing.
              Four left, stacked above rounds and the tools drawer so the left
              of the chart holds one column rather than a group in each corner.
          ...
          <Button aria-label="Zoom out" className="size-7 rounded-lg max-sm:size-10 max-sm:rounded-full max-sm:border max-sm:bg-card/85 max-sm:backdrop-blur-sm" onClick={() => zoomTime(1.5)} variant="ghost">
            <ZoomOutIcon />
          </Button>
          <Button aria-label="Zoom in" className="size-7 rounded-lg max-sm:size-10 max-sm:rounded-full max-sm:border max-sm:bg-card/85 max-sm:backdrop-blur-sm" onClick={() => zoomTime(1 / 1.5)} variant="ghost">
            <ZoomInIcon />
          </Button>
          ...
          <Button
            ...
            className={cn("size-7 rounded-lg max-sm:size-10 max-sm:rounded-full max-sm:border max-sm:bg-card/85 max-sm:backdrop-blur-sm", following && "bg-accent text-foreground")}
            onClick={follow}
            variant="ghost"
          >
            <CrosshairIcon />
          ...
          <Button
            ...
            className="size-7 rounded-lg max-sm:size-10 max-sm:rounded-full max-sm:border max-sm:bg-card/85 max-sm:backdrop-blur-sm"
